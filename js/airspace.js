        ...
        if (typeof L.control.locate === 'function') {
            ...
            if (geoOkAs) {
                ...
                if (typeof GeoLocate !== 'undefined' && GeoLocate.mergeLeafletLocateControlOptions) {
                    locateControlOptsAs = GeoLocate.mergeLeafletLocateControlOptions(locateControlOptsAs);
                } else {
                    locateControlOptsAs.locateOptions = { enableHighAccuracy: true, timeout: 15000, maximumAge: 0 };
                }
                L.control.locate(locateControlOptsAs).addTo(map);
            }
        }
